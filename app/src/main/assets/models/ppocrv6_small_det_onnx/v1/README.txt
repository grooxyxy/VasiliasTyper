...
di folder ini sehingga path lengkapnya:
  app/src/main/assets/models/ppocrv6_small_det_onnx/v1/inference.onnx
...
Saat aplikasi pertama kali menjalankan opsi PP-OCRv6 Small, asset disalin ke:
  <internal filesDir>/models/ppocrv6_small_det_onnx/v1/inference.onnx
